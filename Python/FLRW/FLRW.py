...
# ---------------------------------------------------------
# 1. Coordinate system and FLRW metric definition (Cartesian)
# ---------------------------------------------------------
# Coordinates: (t, x, y, z)
...
# FLRW metric tensor (Cartesian form, flat space k=0)
g = [
    [-1,      0,        0,        0],
    [0,   a**2,        0,        0],
    [0,      0,    a**2,        0],
...
""")
    ...
    f.write("\\section*{FLRW Tensor Calculations}\n")
...
print("✓ DONE! File written to flrw_tensors.tex")
